  ...
  .factory('PointsTest', ['$rootScope', function($rootScope) {
    ...
    function PointsTest(opt) {
      ...
      if ($rootScope.isLeftHandNext) {
        startTriangle.rotate(100);
        targetTriangle.rotate(-1 * targetRotation + 20);
      } else {
      ...
      switch (startPositionQuarter) {
        case "topLeft":
          targetPositionQuarter = "bottomRight";
          break;
        case "topRight":
          targetPositionQuarter = "bottomLeft";
          break;
        case "bottomLeft":
          targetPositionQuarter = "topRight";
          break;
        case "bottomRight":
          targetPositionQuarter = "topLeft";
          break;
      }
      ...
      startTriangle.on('TRIANGLE_MOVED', function(triangle) {
        var doesMatch = triangle.matches(targetTriangle, tolerance);
        if (doesMatch) {
      ...
      function moveTriangleToQuarter(triangle, quarter) {
        ...
        switch (quarter) {
          ...
          case "bottomRight":
            ...
            break;
          default:
            throw new Error("Unknown startPosition");
        }
      }
    }
    return PointsTest;
